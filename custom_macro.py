...
class CUSTOM_MACRO:
    ...
    def cmd_CX_ROUGH_G28(self, gcmd):
        ...
        self.gcode.run_script_from_command('SET_Z_OFFSET')
        ...
        self.gcode.run_script_from_command('M109 S%d' % (self.g28_ext_temp))
        self.gcode.run_script_from_command('M83')
        self.gcode.run_script_from_command('G1 X10 Y10 Z5 F6000')
